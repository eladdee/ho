<section class="SectionContent " style="background: #fff">
   <div class="ContentWrapper TextPageWrapper ComponentLayout Layout CmsStaticPage">
      <span id="ch_3229769240" class="">
         ...
         <p>1.1. Holiganbet.com sitemizi kullanarak, ziyaret ederek veya üye olarak aşağıdaki maddeleri kabul etmiş sayılırsınız:</p>
         <p>1.1.1. Bu sayfadaki Genel Hüküm ve Koşullar.</p>
         <p>1.1.2. Gizlilik Politikası.</p>
         <p>1.1.3. Oyun kuralları.</p>
         <p>1.1.4. Holiganbet üzerinde bulabileceğiniz her türlü promosyon, bonus, özel kampanyaların kural ve koşulları zaman zaman güncellenebilir.</p>
         <p>1.2. Yukarıda listelenen tüm kural ve terimler “Kurallar” olarak anılır.</p>
         <p>1.3. Lütfen kabul etmeden önce kuralları dikkatlice okuyun ve anlayın. Kurallarımızda kabul etmediğiniz bir madde varsa, lütfen Holiganbet’te bir oyuncu hesabı açarak (“Oyuncu Hesabı”) kullanmaya devam etmeyin.Holiganbet’i kullanmaya devam etmeniz, kuralları kabul ettiğiniz anlamına gelecektir.</p>
         <p>1.4. Kurallar 01/01/2020 tarihinden itibaren geçerlidir.</p>
         <ol start="2">
            <li><strong>Taraflar</strong></li>
         </ol>
         <p>2.1. Holiganbet, Curacao hükümeti tarafından düzenlenmektedir. Bu Hizmet, Antilephone’a verilen, Curacao Hükümeti tarafından Yetkilendirilen ve Düzenlenen 8048/JAZ No.lu Lisans kapsamında çalışır.</p>
         <p>Holiganbet, Curaçao yasalarına göre kurulmuş, adresi Heelsumstraat 51, Curaçao’da bulunan ve Curaçao Ticaret ve Sanayi Odası Ticaret Sicilinde 148533 (“Şirket”) kayıtlı olan Coinbar N.V. tarafından işletilmektedir.</p>
         ...
         <p>3.1. Kurallar, ticari nedenlerle, yasa ve yönetmeliklerdeki değişiklikler veya müşteri hizmetleri gibi çeşitli nedenlerle tarafımızca değiştirilebilir. Güncel Kullanım Koşulları Holiganbet’te mevcuttur ve yürürlük tarihleri burada belirtilmektedir.</p>
         <ol start="4">
            <li><strong>Oyuncu Hesabı Oluşturun</strong></li>
         </ol>
         <p>4.1. Holiganbet’te bahis oynamak ve oyun oynamak için bir Oyuncu Hesabı açmalısınız.</p>
         <p>4.2. Çeşitli yasal ve ticari sebeplerden dolayı, bazı ülkelerden Oyuncu Hesabı açılmasına ve Holiganbet’in kullanılmasına izin verilmemektedir. Bu bölgelerde iseniz, Oyuncu Hesabı açmamalı veya Holiganbet’i kullanmamalısınız. Holiganbet’e kaydolmanızı ve/veya bahis oynamanızı engelleyebilecek ülkenizdeki kurallar hakkında kendinizi bilgilendirmek tamamen sizin sorumluluğunuzdadır.</p>
         <p>4.3. Holiganbet’e üye olmak için destek hattından yardım alabilir veya ana sayfadaki “Kayıt Ol” butonuna tıklayarak Oyuncu Hesabı açabilirsiniz.</p>
         ...
         <p>4.5. Holiganbet hizmetlerini (“Hizmetler”) kullanarak para kazanabileceğinizi ve kaybedebileceğinizi kabul etmektesiniz.</p>
         ...
         <p>4.7. Başka bir hesap açmak istiyorsanız, geçerli nedenlerinizi yazılı olarak e-posta adresimize göndermelisiniz: support@holiganbet.com. Yeni hesap açma nedeninizin geçerli olduğu anlaşılırsa eski hesap kapatıldıktan sonra yeni hesap açmanıza izin verilir.</p>
         ...
         <p>7.1. Holiganbet’te bahis oynamak ve oyun oynamak için hesabınıza para yatırmanız gerekir.</p>
         ...
         <p>7.11. Para çekebilmek için, eğer spor bahisleri yapıyorsanız, yatırdığınız miktarın %30’unu, en az 1.30 oranında kullanmanız gerekir. Kombine kuponlar için en az bir maçın oranı 1.30 veya daha yüksek olmalıdır. Eğer yatırımınızı casino, canlı casino veya sanal bahis oyunlarına değerlendirecekseniz, toplam yatırım tutarınızın %30’una bahis yapmalısınız.</p>
         ...
         <p>10.2. Holiganbet’in işleyişini engellemeye çalışmamalı, Hizmetleri etkileyecek virüs, solucan ve benzeri yöntemler kullanmamalısınız. Herhangi bir toplu gönderi veya spam kesinlikle yasaktır. Holiganbet’te yer alan herhangi bir biçimde herhangi bir bilgiyi değiştirmeye veya bunlara müdahale etmeye çalışmamalısınız.</p>
         <p>10.3. Holiganbet sadece eğlence amaçlı kullanılmalıdır ve sitenin tamamının veya bir kısmının izinsiz kopyalanması ve kullanılması yasaktır.</p>
         <p>10.4. Holiganbet’e, Holiganbet’in bulunduğu sunuculara, bilgisayarlara ve veritabanlarına izniniz olmadan erişmeye çalışmamalısınız. Holiganbet’e DDOS(hizmet reddi) veya benzeri sistemlerle saldırmamalısınız. Bu tür girişimlerde bulunmanız durumunda ilgili mercilerle işbirliği yapılacak ve kimlik bilgileriniz paylaşılacaktır. Böyle bir girişim sonucunda üyeliğinizi kullanma hakkınız sona erer.</p>
         <p>10.5. Holiganbet’i kullanırken, Holiganbet’ten dosya indirirken, virüsler, DDOS saldırıları veya çeşitli zararlı teknolojiler nedeniyle bilgisayarınızda, bilgisayar programlarınızda, telefonunuzda, belgelerinizde oluşabilecek herhangi bir kayıp veya hasardan firmamız sorumlu değildir.</p>
         ...
         <p>11.3. Hesap kapatma taleplerinizi ; hesap kapatma nedeniniz ile beraber ”destek@holiganbet.com” mail adresimize gönderim sağlayarak gerçekleştirebilirsiniz. Talebiniz işleme alındıktan sonra 60 iş günü içerisinde aktif olmamanız halinde hesabınız askıya alınacaktır.</p>
         <ol start="12">
            <li><strong>Holiganbet Güncellemeleri</strong></li>
         </ol>
         <p>&nbsp;</p>
         <p>12.1. Holiganbet’teki herhangi bir hizmeti herhangi bir zamanda değiştirmek veya güncellemek tamamen Şirketin takdirindedir.</p>
         <ol start="13">
            <li><strong>Bilgi Teknolojisi Hataları</strong></li>
         </ol>
         <p>13.1. Holiganbet’i sağlayan sistemde herhangi bir yazılım veya donanım hatası veya arızası olması durumunda kısa süre içerisinde müdahale edilerek sorunun giderilmesi sağlanır.</p>
         ...
         <p>14.2. Holiganbet.com yanlış oranlara, değiştirilmiş oranlara (yanlış takımlara karşı verilen oranlar) veya canlı bahis mümkün olmadığında yapılan bahisleri iptal etme hakkını saklı tutar. Holiganbet.com herhangi bir bahsi iptal etme, kısıtlama, reddetme ve sınırlama hakkını saklı tutar.</p>
         ...
         <p>17.1. Tüm Holiganbet tasarımı, metin, grafik, müzik, ses, fotoğraf, video, bunların seçimi ve düzenlenmesi, yazılım derlemeleri, kaynak kodu, yazılım ve tüm materyaller, telif hakkı tarafımıza ait olan veya üçüncü taraf hak sahipleri tarafından lisans altında kullanılan diğer mülkiyet haklarına tabidir. Holiganbet’teki materyaller kişisel kullanım için yalnızca tek bir kişisel bilgisayara indirilebilir ve ticari amaçlarla kullanılamaz.</p>
         ...
         <p>17.3. Holiganbet’te görünen ticari markaların, ticari adların ve logoların kullanımı ve çoğaltılması, kurallarda izin verilmediği sürece yasaktır.</p>
         <ol start="18">
            <li><strong>Kişisel bilgi</strong></li>
         </ol>
         <p>18.1. Holiganbet tarafından alınan kişisel bilgiler, veri güvenliği yasalarına uygun olarak korunmaktadır. Sitemiz, kişisel bilgilerin kullanımına ilişkin yükümlülüklerini titizlikle yerine getirmektedir.</p>
         <p>18.2. Holiganbet’te vermiş olduğunuz kişisel bilgilerin Şirket tarafından site şartlarına uygun olarak, yasal ve düzenleyici yükümlülüklere uygun olarak kullanılmasını kabul etmiş sayılırsınız.</p>
         ...
         <p>19.1. Holiganbet’in etkin kullanımı için “Çerezler” kullanılmaktadır. Çerezler, bilgisayarınıza indirilen ve siteye geri döndüğünüzde hatırlanan küçük metin dosyalarıdır. Çerezlerin nasıl kontrol edileceği ve silineceği ile ilgili bilgiler www.aboutcookies.org adresinde bulunabilir. Çerezleri silerek ve devre dışı bırakarak Holiganbet’in bazı özelliklerine erişemeyebilir veya bunları kullanamayabilirsiniz.</p>
         <ol start="20">
            <li><strong>Şikayetler ve Bildirimler</strong></li>
         </ol>
         <p>20.1. Holiganbet ile ilgili herhangi bir şikayette bulunmak için öncelikle müşteri ilişkileri departmanı ile iletişime geçmelisiniz.</p>
         ...
         <p>27.5. Sorumlu Oyun girişimlerini desteklemeye kararlıyız. Sorunlu Oyun hakkında bilgi edinmek için aşağıdaki siteyi ziyaret etmenizi öneririz.<br>
            <a class="c-link" tabindex="-1" href="http://www.gamblingtherapy.org/" target="_blank" rel="noopener noreferrer" data-stringify-link="http://www.gamblingtherapy.org" data-sk="tooltip_parent" data-remove-tab-index="true">www.gamblingtherapy.org</a>
         </p>
         <ol start="28">
         ...
         <p>29.1. Canlı bir etkinlik sırasında Holiganbet’te görüntülenen herhangi bir istatistik (örn. skor, zaman bilgisi) yalnızca genel bilgi amaçlıdır, doğruluk garantisi yoktur ve bahis oynamak için bunlara güvenilmemelidir.</p>
         ...
         <p>30.4 [tutar] tutarını aşan bonuslar, ancak maddede açıklanan doğrulama sürecini geçtikten sonra verilecektir. 5.4.</p>
         <ol start="31">
